...
const features = [
  {
    ...
    description:
      "Custom ML models for predictive analytics and pattern recognition.",
  },
  {
    icon: <Network className="w-8 h-8" />,
    title: "Neural Networks",
    description:
      "Deep learning solutions for complex data processing and analysis.",
  },
  {
  ...
  },
  {
    ...
    description: "Image and video processing using state-of-the-art AI models.",
  },
];
